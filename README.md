...
Project 1
* Utilize Java Derby to log and store books, authors, and publishers

Project 2
* A MySQL database final project to simulate the restaurant employee/customer model relation

Here's why:
* Intro to database fundamentals
* Reinforce conepts such as entity-relationship models, database design, data definition language, the relational model, data manipulation language, database application programming and normalization.
